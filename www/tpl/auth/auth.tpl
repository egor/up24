<!-- BDP: user_block -->
<p class="center">Здравствуйте, <br /><strong>{USER_FULL_NAME}</strong></p>
<!-- EDP: user_block -->
...
<div class="login_block">
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="password" name="password" /><input type="submit" value="Войти" class="submit" name="auth" /></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
