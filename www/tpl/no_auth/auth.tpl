...
<div class="login_block">
    ...
    <table>
        ...
        <tr>
            <td><input id="remember_me" checked="checked" style="width: 15px; height: 15px; margin-top: 0px; margin-left: 0px; border: none;" type="checkbox" value="1" name="remember_me"><label for="remember_me">&nbsp;&nbsp;Запомнить меня</label></td>
            <td><a href="/remind" class="remind">Забыли пароль?</a></td>
        </tr>
    </table>
    </form>
</div>
